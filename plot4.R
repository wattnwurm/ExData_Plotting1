...
plot(hpc2$Date, hpc2$Global_active_power,type="l",  
     xlab="",ylab="Global Active Power")

plot(hpc2$Date, hpc2$Voltage, type="l",  xlab="datetime",ylab="Voltage")

plot(hpc2$Date, hpc2$Sub_metering_1, type="l",  
     xlab="",ylab="Energy sub metering")
lines(hpc2$Date, hpc2$Sub_metering_2, col="red")
lines(hpc2$Date, hpc2$Sub_metering_3, col="blue")
legend("topright",horiz=F,legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
       col=c("black","red","blue"),lty=1,bty="n", adj=c(0,0.25))

plot(hpc2$Date, hpc2$Global_reactive_power, type="l",  
